...
class WPSDB extends WPSDB_Base
{
    ...
    public function ajax_blacklist_plugins()
    {
    ...
    public function output_log_file()
    {
    ...
    public function output_diagnostic_info()
    {
        global $table_prefix;
        global $wpdb;
    ...
    public function get_alter_queries()
    {
        global $wpdb;
        $alter_table_name = $this->get_alter_table_name();
        $sql = '';
    ...
    public function get_table_row_count()
    {
        global $wpdb;
    ...
    public function format_dump_name($dump_name)
    {
        $extension = '.sql';
...
// select profile if more than > 1 profile saved
    ...
    public function apply_replaces($subject, $is_serialized = false)
    {
    ...
    public function table_is($desired_table, $given_table)
    {
        global $wpdb;
     ...
     */
    public function get_ms_compat_table_names($tables, $queried_table)
    {
        global $wpdb;
    ...
    public function db_backup_header()
    {
        $charset = (defined('DB_CHARSET') ? DB_CHARSET : 'utf8');
    ...
    public function stow($query_line, $replace = true)
    {
    ...
    public function after_admin_menu($hook_suffix)
    {
    ...
    public function admin_head_connection_info()
    {
        global $table_prefix;
    ...
    public function maybe_update_profile($profile, $profile_id)
    {
    ...
    public function maybe_checked($option)
    {
    ...
    public function respond_to_process_push_migration_cancellation()
    {
    ...
    public function empty_current_chunk()
    {
        $this->current_chunk = '';
    }
