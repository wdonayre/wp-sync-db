...
class WPSDB_Base
{
    ...
    public function remote_post($url, $data, $scope, $args = array(), $expecting_serial = false)
    {
        $this->set_time_limit();
    ...
    public function retry_remote_post($url, $data, $scope, $args = array(), $expecting_serial = false)
    {
        $url = substr_replace($url, 'http', 0, 5);
    ...
    public function file_to_multipart($file)
    {
        $result = '';
    ...
    public function log_error($wpsdb_error, $additional_error_var = false)
    {
    ...
    public function filter_post_elements($post_array, $accepted_elements)
    {
    ...
    public function get_class_props()
    {
    ...
    public function set_cli_migration()
    {
