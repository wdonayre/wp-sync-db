...
class WPSDB_Addon extends WPSDB_Base
{
    ...
    public function meets_version_requirements($version_required)
    {
    ...
    public function hook_version_requirement_actions()
    {
        add_action('wpsdb_notices', array($this, 'version_requirement_actions'));
    }

    public function version_requirement_actions()
    {
    ...
    public function version_requirement_warning()
    {
        ...
        <div class="updated warning inline-message below-h2">
            ...
            <?php printf(__('The version of %1$s you have installed, requires version %2$s of WP Sync DB. You currently have %3$s installed. <strong><a href="%4$s">Update Now</a></strong>', 'wp-sync-db'), $addon_name, $required, $installed, $update);?>
        </div>
        <?php
    }
}
