        ...
        <div class="step-two">
            ...
            <div class="option-section">
                <div class="header-wrapper clearfix">
                    <div class="option-heading find-heading">
                        <?php _e('Find', 'wp-sync-db');?>
                    </div>
                    <div class="option-heading replace-heading">
                        <?php _e('Replace', 'wp-sync-db');?>
                    </div>
                </div>

                <p class="no-replaces-message">
                    <?php _e('Doesn\'t look we have any replaces yet, <a href="#" class="js-action-link add-replace">add one?</a>', 'wp-sync-db');?>
                </p>
                ...
                <div id="new-url-missing-warning" class="warning inline-message missing-replace">
                    <?php printf(__('<strong>New URL Missing</strong> &mdash; Please enter the protocol-relative URL of the remote website in the "New URL" field. If you are unsure of what this URL should be, please consult <a href="%s" target="_blank">our documentation</a> on find and replace fields.', 'wp-sync-db'), 'https://deliciousbrains.com/wp-sync-db/documentation/#find-and-replace');?>
                </div>
                <div id="new-path-missing-warning" class="warning inline-message missing-replace">
                    <?php printf(__('<strong>New File Path Missing</strong> &mdash; Please enter the root file path of the remote website in the "New file path" field. If you are unsure of what the file path should be, please consult <a href="%s" target="_blank">our documentation</a> on find and replace fields.', 'wp-sync-db'), 'https://deliciousbrains.com/wp-sync-db/documentation/#find-and-replace');?>
                </div>
            ...
            <div class="option-section save-migration-profile-wrap">
                ...
                <div class="indent-wrap expandable-content">
                    <ul class="option-group">
                        <?php foreach ($this->settings['profiles'] as $profile_id => $profile) {++$profile_id;?>
                            <li>
